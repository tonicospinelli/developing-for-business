...
class FindOneByEmailAndItemIdStatementStub extends \PDOStatement
{
    /**
     * @var array
     */
...
LIMIT 1';
    ...
    public function fetchAll($fetch_style = null, $fetch_argument = null, $ctor_args = [])
    {
        return array_filter($this->rows, function (Wishlist $wishlist) {
            return $wishlist->getEmail() === $this->filter[0] &&
            $wishlist->getItemId() === $this->filter[1];
        });
    }
}
